...
import de.sorted.chaos.jump.graphic.entity.Shader
import de.sorted.chaos.jump.graphic.render.texture.UniformUpload
...
object AnimationRenderer {
  ...
  def draw(mvp: Matrix4f,
           animatedEntity: AnimatedEntity): Unit = {
